...
export const ComoIniciarLGPD: BlogPost = {
  slug: "como-iniciar-lgpd",
  title: "Como iniciar a adequação à LGPD em pequenas e médias empresas",
  excerpt:
    "Pequenas e médias empresas também precisam se adequar à LGPD. Veja como iniciar esse processo de forma simples, prática e sem juridiquês.",
  content:`
---
